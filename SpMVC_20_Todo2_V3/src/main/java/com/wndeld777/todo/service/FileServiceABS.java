package com.wndeld777.todo.service;
 ...
 * 2. 중요한 method 는 직접 만들어서 사용할 수 있도록 구성된 클래스
 */
@Slf4j
public abstract class FileServiceABS {
	 ...
	 * winFilePath, macFilePath 값을 가져와서 변수에 세팅하는 코드
	 * 
	 */
	@Autowired
	public void fileUpPath(String winPath,String macPath) {
		...
		log.debug("파일 지정폴더 {} " , this.fileUpPath);
