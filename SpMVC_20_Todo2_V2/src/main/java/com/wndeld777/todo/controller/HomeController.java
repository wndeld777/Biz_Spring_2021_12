package com.wndeld777.todo.controller;
...
import com.wndeld777.todo.config.QualifierConfig;
import com.wndeld777.todo.service.FileServiceABS;
...
public class HomeController {
	...
	public Map<String, String> upload(String to_text, @RequestParam("to_image") MultipartFile to_image){
